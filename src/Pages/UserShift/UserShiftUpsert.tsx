...
function UserShiftUpsert() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("userId", userShiftInputs.userId);
   
    formData.append("date", userShiftInputs.date);
    ...
    if (id) {
      ...
      response = await updateUserShift({ data: formData, id });
    ...
    if (response) {
      setLoading(false);
      navigate("/userShift/userShiftlist");
    }
